...
export const number = new Hono<HonoEnv>();
...
number.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.number.bigInt(
        c.req.valid('json'),
      ).toString(),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.number.binary(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.number.float(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.number.octal(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.number.romanNumeral(
        c.req.valid('json'),
      ),
    });
  },
