...
export const location = new Hono<HonoEnv>();
...
location.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.buildingNumber(),
    });
  },
).post(
  '/cardinalDirection',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.cardinalDirection(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.city(),
    });
  },
).post(
  '/continent',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.continent(),
    });
  },
).post(
  '/country',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.country(),
    });
  },
).post(
  '/countryCode',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.countryCode(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.county(),
    });
  },
).post(
  '/direction',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.direction(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.latitude(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.longitude(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.nearbyGPSCoordinate(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.ordinalDirection(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.secondaryAddress(),
    });
  },
).post(
  '/state',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.state(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.street(),
    });
  },
).post(
  '/streetAddress',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.streetAddress(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.timeZone(),
    });
  },
).post(
  '/zipCode',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.location.zipCode(
        c.req.valid('json'),
      ),
    });
  },
