...
export const date = new Hono<HonoEnv>();
...
date.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.date.anytime(
        c.req.valid('json'),
      ).toISOString(),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.date.between(
        c.req.valid('json'),
      ).toISOString(),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.date.betweens(
        c.req.valid('json'),
      ).map((d) => d.toISOString()),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.date.birthdate(
        c.req.valid('json'),
      ).toISOString(),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.date.timeZone(),
    });
  },
).post(
  '/weekday',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.date.weekday(
        c.req.valid('json'),
      ),
    });
  },
