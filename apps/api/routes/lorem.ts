...
export const lorem = new Hono<HonoEnv>();
...
lorem.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.lorem.paragraph(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.lorem.paragraphs(
        c.req.valid('json'),
  ...
  (c) => {
    return c.json({
      value: c.var.faker.lorem.sentence(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.lorem.sentences(
        c.req.valid('json'),
        c.req.valid('json')?.separator,
      ),
    });
