...
export const internet = new Hono<HonoEnv>();
...
internet.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.color(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.displayName(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.domainName(),
    });
  },
).post(
  '/domainSuffix',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.domainSuffix(),
    });
  },
).post(
  '/domainWord',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.domainWord(),
    });
  },
).post(
  '/email',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.email(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.emoji(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.exampleEmail(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.httpMethod(),
    });
  },
).post(
  '/httpStatusCode',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.httpStatusCode(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.ipv4(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.ipv6(),
    });
  },
).post(
  '/jwt',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.jwt(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.mac(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.password(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.port(),
    });
  },
).post(
  '/protocol',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.protocol(),
    });
  },
).post(
  '/url',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.url(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.userAgent(),
    });
  },
).post(
  '/username',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.internet.username(
        c.req.valid('json'),
      ),
    });
  },
