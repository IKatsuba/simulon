...
export const airline = new Hono<HonoEnv>();
...
airline.post(
  ...
  (c) => {
    return c.json({ value: c.var.faker.airline.aircraftType() });
  },
).post(
  '',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.airline.airline() });
  },
).post(
  '/airplane',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.airline.airplane() });
  },
).post(
  '/airport',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.airline.airport() });
  },
).post(
  '/flightNumber',
  describeRoute({
  ...
  (c) => {
    return c.json({
      value: c.var.faker.airline.flightNumber(c.req.valid('json')),
    });
  },
).post(
  '/recordLocator',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.airline.recordLocator(c.req.valid('json')),
    });
  },
).post(
  '/seat',
  ...
  (c) => {
    return c.json({ value: c.var.faker.airline.seat(c.req.valid('json')) });
  },
);
