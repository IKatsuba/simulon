...
export const finance = new Hono<HonoEnv>();
...
finance.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.accountName(),
    });
  },
).post(
  '/accountNumber',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.accountNumber(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.amount(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.bitcoinAddress(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.creditCardCVV(),
    });
  },
).post(
  '/creditCardIssuer',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.creditCardIssuer(),
    });
  },
).post(
  '/creditCardNumber',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.creditCardNumber(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.currencyCode(),
    });
  },
).post(
  '/currencyName',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.currencyName(),
    });
  },
).post(
  '/currencySymbol',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.currencySymbol(),
    });
  },
).post(
  '/ethereumAddress',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.ethereumAddress(),
    });
  },
).post(
  '/iban',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.iban(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.litecoinAddress(),
    });
  },
).post(
  '/pin',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.routingNumber(),
    });
  },
).post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.transactionDescription(),
    });
  },
).post(
  '/transactionType',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.finance.transactionType(),
    });
  },
);
