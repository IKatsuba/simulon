...
export const company = new Hono<HonoEnv>();
...
company.post(
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.name() });
  },
).post(
  '/catchPhrase',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.catchPhrase() });
  },
).post(
  '/buzzPhrase',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.buzzPhrase() });
  },
).post(
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.catchPhraseAdjective() });
  },
).post(
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.catchPhraseDescriptor() });
  },
).post(
  '/catchPhraseNoun',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.catchPhraseNoun() });
  },
).post(
  '/buzzAdjective',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.buzzAdjective() });
  },
).post(
  '/buzzVerb',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.buzzVerb() });
  },
).post(
  '/buzzNoun',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: c.var.faker.company.buzzNoun() });
  },
);
