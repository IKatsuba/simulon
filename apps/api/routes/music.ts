...
export const music = new Hono<HonoEnv>();
...
music.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.music.artist(),
    });
  },
).post(
  '/genre',
  ...
  (c) => {
    return c.json({
      value: c.var.faker.music.songName(),
    });
  },
);
