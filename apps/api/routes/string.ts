...
export const string = new Hono<HonoEnv>();
...
string.post(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.alpha(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.alphanumeric(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.binary(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.fromCharacters(
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.hexadecimal(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.nanoid(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.numeric(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.octal(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.sample(
        c.req.valid('json'),
      ),
    });
  },
  ...
  (c) => {
    return c.json({
      value: c.var.faker.string.symbol(
        c.req.valid('json'),
      ),
    });
  },
