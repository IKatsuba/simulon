...
animal.post(
  ...
  (c) => {
    return c.json({ value: faker.animal.bear() });
  },
).post(
  '/bird',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.bird() });
  },
).post(
  '/cat',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.cat() });
  },
).post(
  '/cow',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.cow() });
  },
).post(
  '/crocodilia',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.crocodilia() });
  },
).post(
  '/dog',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.dog() });
  },
).post(
  '/fish',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.fish() });
  },
).post(
  '/horse',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.horse() });
  },
).post(
  '/insect',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.insect() });
  },
).post(
  '/lion',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.lion() });
  },
).post(
  '/petName',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.petName() });
  },
).post(
  '/rabbit',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.rabbit() });
  },
).post(
  '/rodent',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.rodent() });
  },
).post(
  '/snake',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.snake() });
  },
).post(
  '/type',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.animal.type() });
  },
);
