...
book.post(
  ...
  (c) => {
    return c.json({ value: faker.book.author() });
  },
).post(
  '/format',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.book.format() });
  },
).post(
  '/genre',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.book.genre() });
  },
).post(
  '/publisher',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.book.publisher() });
  },
).post(
  '/series',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.book.series() });
  },
).post(
  '/title',
  describeRoute({
  ...
  (c) => {
    return c.json({ value: faker.book.title() });
  },
);
